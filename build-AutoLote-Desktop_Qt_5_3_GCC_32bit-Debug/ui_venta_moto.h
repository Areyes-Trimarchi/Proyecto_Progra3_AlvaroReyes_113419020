...
public:
    ...
    void setupUi(QDialog *Venta_moto)
    {
        ...
        rb_carretilla_no_venta->setEnabled(false);
        ...
        rb_estado_malo_carretilla_venta->setEnabled(false);
        ...
        rb_estado_bueno_carretilla_venta->setEnabled(false);
        ...
        rb_estado_bueno_moto_venta->setEnabled(false);
        ...
        rb_estado_malo_moto_venta->setEnabled(false);
        ...
        rb_estado_reparado_moto_venta->setEnabled(false);
        ...
        rb_carretilla_si_venta->setEnabled(false);
        ...
        rb_estado_reparado_carretilla_venta->setEnabled(false);
